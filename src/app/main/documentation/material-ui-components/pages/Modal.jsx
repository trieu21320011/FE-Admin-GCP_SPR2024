...
Modal is a lower-level construct that is leveraged by the following components:</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicModal.js" className="my-16" iframe={false} component={BasicModalComponent} raw={BasicModalRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="NestedModal.js" className="my-16" iframe={false} component={NestedModalComponent} raw={NestedModalRaw}/></Typography>
...
These two callbacks allow the modal to unmount the child content when closed and fully transitioned.</li>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TransitionsModal.js" className="my-16" iframe={false} component={TransitionsModalComponent} raw={TransitionsModalRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SpringModal.js" className="my-16" iframe={false} component={SpringModalComponent} raw={SpringModalRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="KeepMountedModal.js" className="my-16" iframe={false} component={KeepMountedModalComponent} raw={KeepMountedModalRaw}/></Typography>
...
In order to display the modal, you need to disable the portal feature with the <code>{`disablePortal`}</code> prop:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ServerModal.js" className="my-16" iframe={false} component={ServerModalComponent} raw={ServerModalRaw}/></Typography>
