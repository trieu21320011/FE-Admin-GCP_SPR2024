...
(The prop is converted into a CSS property using the <a href="/material-ui/customization/spacing/"><code>{`theme.spacing()`}</code></a> helper.)</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicStack.js" className="my-16" iframe={false} component={BasicStackComponent} raw={BasicStackRaw}/></Typography>
...
Use the <code>{`direction`}</code> prop to position items horizontally in a row:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DirectionStack.js" className="my-16" iframe={false} component={DirectionStackComponent} raw={DirectionStackRaw}/></Typography>
...
This works particularly well with the <a href="/material-ui/react-divider/">Divider</a> component, as shown below:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DividerStack.js" className="my-16" iframe={false} component={DividerStackComponent} raw={DividerStackRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ResponsiveStack.js" className="my-16" iframe={false} component={ResponsiveStackComponent} raw={ResponsiveStackRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FlexboxGapStack.js" className="my-16" iframe={false} component={FlexboxGapStackComponent} raw={FlexboxGapStackRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="InteractiveStack.js" className="my-16" iframe={false} component={InteractiveStackComponent} raw={InteractiveStackRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ZeroWidthStack.js" className="my-16" iframe={false} component={ZeroWidthStackComponent} raw={ZeroWidthStackRaw}/></Typography>
