...
function AccordionDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AccordionUsage.js" className="my-16" iframe={false} component={AccordionUsageComponent} raw={AccordionUsageRaw}/></Typography>
...
The component handles the turning upside-down transition automatically.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AccordionExpandIcon.js" className="my-16" iframe={false} component={AccordionExpandIconComponent} raw={AccordionExpandIconRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AccordionExpandDefault.js" className="my-16" iframe={false} component={AccordionExpandDefaultComponent} raw={AccordionExpandDefaultRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AccordionTransition.js" className="my-16" iframe={false} component={AccordionTransitionComponent} raw={AccordionTransitionRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DisabledAccordion.js" className="my-16" iframe={false} component={DisabledAccordionComponent} raw={DisabledAccordionRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ControlledAccordions.js" className="my-16" iframe={false} component={ControlledAccordionsComponent} raw={ControlledAccordionsRaw}/></Typography>
    <div className="border border-1 p-16 rounded-16 my-12">
...
The demo below also shows a bit of visual customziation.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedAccordions.js" className="my-16" iframe={false} component={CustomizedAccordionsComponent} raw={CustomizedAccordionsRaw}/></Typography>
