...
function ButtonsDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicButtons.js" className="my-16" iframe={false} component={BasicButtonsComponent} raw={BasicButtonsRaw}/></Typography>
...
In cards, text buttons help maintain an emphasis on card content.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TextButtons.js" className="my-16" iframe={false} component={TextButtonsComponent} raw={TextButtonsRaw}/></Typography>
...
They contain actions that are primary to your app.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ContainedButtons.js" className="my-16" iframe={false} component={ContainedButtonsComponent} raw={ContainedButtonsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DisableElevation.js" className="my-16" iframe={false} component={DisableElevationComponent} raw={DisableElevationRaw}/></Typography>
...
or a higher emphasis alternative to text buttons.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="OutlinedButtons.js" className="my-16" iframe={false} component={OutlinedButtonsComponent} raw={OutlinedButtonsRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorButtons.js" className="my-16" iframe={false} component={ColorButtonsComponent} raw={ColorButtonsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ButtonSizes.js" className="my-16" iframe={false} component={ButtonSizesComponent} raw={ButtonSizesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconLabelButtons.js" className="my-16" iframe={false} component={IconLabelButtonsComponent} raw={IconLabelButtonsRaw}/></Typography>
...
deselected, such as adding or removing a star to an item.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconButtons.js" className="my-16" iframe={false} component={IconButtonsComponent} raw={IconButtonsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconButtonSizes.js" className="my-16" iframe={false} component={IconButtonSizesComponent} raw={IconButtonSizesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconButtonColors.js" className="my-16" iframe={false} component={IconButtonColorsComponent} raw={IconButtonColorsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="InputFileUpload.js" className="my-16" iframe={false} component={InputFileUploadComponent} raw={InputFileUploadRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedButtons.js" className="my-16" iframe={false} component={CustomizedButtonsComponent} raw={CustomizedButtonsRaw}/></Typography>
...
You can take advantage of this lower-level component to build custom interactions.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ButtonBaseDemo.js" className="my-16" iframe={false} component={ButtonBaseDemoComponent} raw={ButtonBaseDemoRaw}/></Typography>
