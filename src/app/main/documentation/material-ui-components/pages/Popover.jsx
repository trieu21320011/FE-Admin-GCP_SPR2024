...
function PopoverDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicPopover.js" className="my-16" iframe={false} component={BasicPopoverComponent} raw={BasicPopoverRaw}/></Typography>
...
the position of the popover.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MouseOverPopover.js" className="my-16" iframe={false} component={MouseOverPopoverComponent} raw={MouseOverPopoverRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VirtualElementPopover.js" className="my-16" iframe={false} component={VirtualElementPopoverComponent} raw={VirtualElementPopoverRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PopoverPopupState.js" className="my-16" iframe={false} component={PopoverPopupStateComponent} raw={PopoverPopupStateRaw}/></Typography>
