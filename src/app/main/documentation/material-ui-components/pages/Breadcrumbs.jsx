...
function BreadcrumbsDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicBreadcrumbs.js" className="my-16" iframe={false} component={BasicBreadcrumbsComponent} raw={BasicBreadcrumbsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ActiveLastBreadcrumb.js" className="my-16" iframe={false} component={ActiveLastBreadcrumbComponent} raw={ActiveLastBreadcrumbRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomSeparator.js" className="my-16" iframe={false} component={CustomSeparatorComponent} raw={CustomSeparatorRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Breadcrumbs with icons</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconBreadcrumbs.js" className="my-16" iframe={false} component={IconBreadcrumbsComponent} raw={IconBreadcrumbsRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Collapsed breadcrumbs</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CollapsedBreadcrumbs.js" className="my-16" iframe={false} component={CollapsedBreadcrumbsComponent} raw={CollapsedBreadcrumbsRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedBreadcrumbs.js" className="my-16" iframe={false} component={CustomizedBreadcrumbsComponent} raw={CustomizedBreadcrumbsRaw}/></Typography>
