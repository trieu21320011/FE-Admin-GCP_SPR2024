...
If you have a single option, avoid using a checkbox and use an on/off switch instead.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Checkboxes.js" className="my-16" iframe={false} component={CheckboxesComponent} raw={CheckboxesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CheckboxLabels.js" className="my-16" iframe={false} component={CheckboxLabelsComponent} raw={CheckboxLabelsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SizeCheckboxes.js" className="my-16" iframe={false} component={SizeCheckboxesComponent} raw={SizeCheckboxesRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Color</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorCheckboxes.js" className="my-16" iframe={false} component={ColorCheckboxesComponent} raw={ColorCheckboxesRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Icon</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconCheckboxes.js" className="my-16" iframe={false} component={IconCheckboxesComponent} raw={IconCheckboxesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ControlledCheckbox.js" className="my-16" iframe={false} component={ControlledCheckboxComponent} raw={ControlledCheckboxRaw}/></Typography>
...
Visually, there are <strong>three</strong> states a checkbox can be in: checked, unchecked, or indeterminate.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IndeterminateCheckbox.js" className="my-16" iframe={false} component={IndeterminateCheckboxComponent} raw={IndeterminateCheckboxRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CheckboxesGroup.js" className="my-16" iframe={false} component={CheckboxesGroupComponent} raw={CheckboxesGroupRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FormControlLabelPosition.js" className="my-16" iframe={false} component={FormControlLabelPositionComponent} raw={FormControlLabelPositionRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedCheckbox.js" className="my-16" iframe={false} component={CustomizedCheckboxComponent} raw={CustomizedCheckboxRaw}/></Typography>
