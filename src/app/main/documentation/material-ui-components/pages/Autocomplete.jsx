...
function AutocompleteDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ComboBox.js" className="my-16" iframe={false} component={ComboBoxComponent} raw={ComboBoxRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Playground.js" className="my-16" iframe={false} component={PlaygroundComponent} raw={PlaygroundRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CountrySelect.js" className="my-16" iframe={false} component={CountrySelectComponent} raw={CountrySelectRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ControllableStates.js" className="my-16" iframe={false} component={ControllableStatesComponent} raw={ControllableStatesRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FreeSolo.js" className="my-16" iframe={false} component={FreeSoloComponent} raw={FreeSoloRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FreeSoloCreateOption.js" className="my-16" iframe={false} component={FreeSoloCreateOptionComponent} raw={FreeSoloCreateOptionRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FreeSoloCreateOptionDialog.js" className="my-16" iframe={false} component={FreeSoloCreateOptionDialogComponent} raw={FreeSoloCreateOptionDialogRaw}/></Typography>
...
otherwise, you will notice duplicate headers.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Grouped.js" className="my-16" iframe={false} component={GroupedComponent} raw={GroupedRaw}/></Typography>
...
This is a function that accepts an object with two fields:</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RenderGroup.js" className="my-16" iframe={false} component={RenderGroupComponent} raw={RenderGroupRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Disabled options</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DisabledOptions.js" className="my-16" iframe={false} component={DisabledOptionsComponent} raw={DisabledOptionsRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="UseAutocomplete.js" className="my-16" iframe={false} component={UseAutocompleteComponent} raw={UseAutocompleteRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Customized hook</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedHook.js" className="my-16" iframe={false} component={CustomizedHookComponent} raw={CustomizedHookRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Asynchronous.js" className="my-16" iframe={false} component={AsynchronousComponent} raw={AsynchronousRaw}/></Typography>
...
For this demo, we need to load the <a href="https://developers.google.com/maps/documentation/javascript/overview">Google Maps JavaScript</a> and <a href="https://developers.google.com/maps/documentation/places/web-service/overview">Google Places</a> API.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="GoogleMaps.js" className="my-16" iframe={false} component={GoogleMapsComponent} raw={GoogleMapsRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Tags.js" className="my-16" iframe={false} component={TagsComponent} raw={TagsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FixedTags.js" className="my-16" iframe={false} component={FixedTagsComponent} raw={FixedTagsRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Checkboxes</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CheckboxesTags.js" className="my-16" iframe={false} component={CheckboxesTagsComponent} raw={CheckboxesTagsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LimitTags.js" className="my-16" iframe={false} component={LimitTagsComponent} raw={LimitTagsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Sizes.js" className="my-16" iframe={false} component={SizesComponent} raw={SizesRaw}/></Typography>
...
:::</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomInputAutocomplete.js" className="my-16" iframe={false} component={CustomInputAutocompleteComponent} raw={CustomInputAutocompleteRaw}/></Typography>
...
This approach enables different options for each Autocomplete component while keeping the options styling consistent.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="GloballyCustomizedOptions.js" className="my-16" iframe={false} component={GloballyCustomizedOptionsComponent} raw={GloballyCustomizedOptionsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="GitHubLabel.js" className="my-16" iframe={false} component={GitHubLabelComponent} raw={GitHubLabelRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AutocompleteHint.js" className="my-16" iframe={false} component={AutocompleteHintComponent} raw={AutocompleteHintRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Highlights.js" className="my-16" iframe={false} component={HighlightsComponent} raw={HighlightsRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Filter.js" className="my-16" iframe={false} component={FilterComponent} raw={FilterRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Virtualize.js" className="my-16" iframe={false} component={VirtualizeComponent} raw={VirtualizeRaw}/></Typography>
