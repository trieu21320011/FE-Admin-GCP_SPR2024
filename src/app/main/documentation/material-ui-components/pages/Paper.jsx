...
:::</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimplePaper.js" className="my-16" iframe={false} component={SimplePaperComponent} raw={SimplePaperRaw}/></Typography>
...
:::</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Elevation.js" className="my-16" iframe={false} component={ElevationComponent} raw={ElevationRaw}/></Typography>
...
Add the <code>{`square`}</code> prop for square corners:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SquareCorners.js" className="my-16" iframe={false} component={SquareCornersComponent} raw={SquareCornersRaw}/></Typography>
