...
function TransferListDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TransferList.js" className="my-16" iframe={false} component={TransferListComponent} raw={TransferListRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SelectAllTransferList.js" className="my-16" iframe={false} component={SelectAllTransferListComponent} raw={SelectAllTransferListRaw}/></Typography>
