...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Variants.js" className="my-16" iframe={false} component={VariantsComponent} raw={VariantsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Animations.js" className="my-16" iframe={false} component={AnimationsComponent} raw={AnimationsRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Pulsate example</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="YouTube.js" className="my-16" iframe={false} component={YouTubeComponent} raw={YouTubeRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Wave example</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Facebook.js" className="my-16" iframe={false} component={FacebookComponent} raw={FacebookRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SkeletonTypography.js" className="my-16" iframe={false} component={SkeletonTypographyComponent} raw={SkeletonTypographyRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SkeletonChildren.js" className="my-16" iframe={false} component={SkeletonChildrenComponent} raw={SkeletonChildrenRaw}/></Typography>
...
This is especially useful when on a black background (as the skeleton will otherwise be invisible).</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SkeletonColor.js" className="my-16" iframe={false} component={SkeletonColorComponent} raw={SkeletonColorRaw}/></Typography>
