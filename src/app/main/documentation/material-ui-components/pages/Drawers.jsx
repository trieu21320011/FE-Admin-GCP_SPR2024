...
It closes when an item is selected, handled by controlling the <code>{`open`}</code> prop.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TemporaryDrawer.js" className="my-16" iframe={false} component={TemporaryDrawerComponent} raw={TemporaryDrawerRaw}/></Typography>
...
You can use the <code>{`disableBackdropTransition`}</code> prop to help.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SwipeableTemporaryDrawer.js" className="my-16" iframe={false} component={SwipeableTemporaryDrawerComponent} raw={SwipeableTemporaryDrawerRaw}/></Typography>
...
If you are on mobile, you can open the demo in CodeSandbox (&quot;edit&quot; icon) and swipe.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SwipeableEdgeDrawer.js" className="my-16" iframe={true} component={SwipeableEdgeDrawerComponent} raw={SwipeableEdgeDrawerRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ResponsiveDrawer.js" className="my-16" iframe={true} component={ResponsiveDrawerComponent} raw={ResponsiveDrawerRaw}/></Typography>
...
They are not recommended for apps with multiple levels of hierarchy that require using an up arrow for navigation.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PersistentDrawerLeft.js" className="my-16" iframe={true} component={PersistentDrawerLeftComponent} raw={PersistentDrawerLeftRaw}/>
    <FuseExample name="PersistentDrawerRight.js" className="my-16" iframe={true} component={PersistentDrawerRightComponent} raw={PersistentDrawerRightRaw}/></Typography>
...
When expanded, it appears as the standard persistent navigation drawer.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MiniDrawer.js" className="my-16" iframe={true} component={MiniDrawerComponent} raw={MiniDrawerRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PermanentDrawerLeft.js" className="my-16" iframe={true} component={PermanentDrawerLeftComponent} raw={PermanentDrawerLeftRaw}/>
    <FuseExample name="PermanentDrawerRight.js" className="my-16" iframe={true} component={PermanentDrawerRightComponent} raw={PermanentDrawerRightRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ClippedDrawer.js" className="my-16" iframe={true} component={ClippedDrawerComponent} raw={ClippedDrawerRaw}/></Typography>
