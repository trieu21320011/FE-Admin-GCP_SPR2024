...
For example, they can display avatars, icons, clarifying subtext, or orthogonal actions (such as adding an account).</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleDialogDemo.js" className="my-16" iframe={false} component={SimpleDialogDemoComponent} raw={SimpleDialogDemoRaw}/></Typography>
...
Users should be able to understand the choices based on the title and button text alone.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AlertDialog.js" className="my-16" iframe={false} component={AlertDialogComponent} raw={AlertDialogRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AlertDialogSlide.js" className="my-16" iframe={false} component={AlertDialogSlideComponent} raw={AlertDialogSlideRaw}/></Typography>
...
For example, if your site prompts for potential subscribers to fill in their email address, they can fill out the email field and touch &#39;Submit&#39;.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FormDialog.js" className="my-16" iframe={false} component={FormDialogComponent} raw={FormDialogRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedDialogs.js" className="my-16" iframe={false} component={CustomizedDialogsComponent} raw={CustomizedDialogsRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Full-screen dialogs</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FullScreenDialog.js" className="my-16" iframe={false} component={FullScreenDialogComponent} raw={FullScreenDialogRaw}/></Typography>
...
When the <code>{`fullWidth`}</code> prop is true, the dialog will adapt based on the <code>{`maxWidth`}</code> value.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MaxWidthDialog.js" className="my-16" iframe={false} component={MaxWidthDialogComponent} raw={MaxWidthDialogRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ResponsiveDialog.js" className="my-16" iframe={false} component={ResponsiveDialogComponent} raw={ResponsiveDialogRaw}/></Typography>
...
For example, users can listen to multiple ringtones but only make a final selection upon touching &quot;OK&quot;.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ConfirmationDialog.js" className="my-16" iframe={false} component={ConfirmationDialogComponent} raw={ConfirmationDialogRaw}/></Typography>
...
Visit <a href="https://www.nngroup.com/articles/modal-nonmodal-dialog/">the Nielsen Norman Group article</a> for more in-depth guidance about modal vs. non-modal dialog usage.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CookiesBanner.js" className="my-16" iframe={true} component={CookiesBannerComponent} raw={CookiesBannerRaw}/></Typography>
...
This will make the entire dialog draggable.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DraggableDialog.js" className="my-16" iframe={false} component={DraggableDialogComponent} raw={DraggableDialogRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ScrollDialog.js" className="my-16" iframe={false} component={ScrollDialogComponent} raw={ScrollDialogRaw}/></Typography>
