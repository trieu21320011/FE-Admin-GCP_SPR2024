...
not shown in context.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicChips.js" className="my-16" iframe={false} component={BasicChipsComponent} raw={BasicChipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ClickableChips.js" className="my-16" iframe={false} component={ClickableChipsComponent} raw={ClickableChipsRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Deletable</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DeletableChips.js" className="my-16" iframe={false} component={DeletableChipsComponent} raw={DeletableChipsRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Clickable and deletable</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ClickableAndDeletableChips.js" className="my-16" iframe={false} component={ClickableAndDeletableChipsComponent} raw={ClickableAndDeletableChipsRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Clickable link</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ClickableLinkChips.js" className="my-16" iframe={false} component={ClickableLinkChipsComponent} raw={ClickableLinkChipsRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Custom delete icon</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomDeleteIconChips.js" className="my-16" iframe={false} component={CustomDeleteIconChipsComponent} raw={CustomDeleteIconChipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AvatarChips.js" className="my-16" iframe={false} component={AvatarChipsComponent} raw={AvatarChipsRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Icon chip</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconChips.js" className="my-16" iframe={false} component={IconChipsComponent} raw={IconChipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorChips.js" className="my-16" iframe={false} component={ColorChipsComponent} raw={ColorChipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SizesChips.js" className="my-16" iframe={false} component={SizesChipsComponent} raw={SizesChipsRaw}/></Typography>
...
To have them support multiline content, use the <code>{`sx`}</code> prop to add <code>{`height:auto`}</code> to the Chip component, and <code>{`whiteSpace: normal`}</code> to the <code>{`label`}</code> styles.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MultilineChips.js" className="my-16" iframe={false} component={MultilineChipsComponent} raw={MultilineChipsRaw}/></Typography>
...
gain depth while clicked or touched.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ChipsArray.js" className="my-16" iframe={false} component={ChipsArrayComponent} raw={ChipsArrayRaw}/></Typography>
