...
Steppers may display a transient feedback message after a step is saved.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HorizontalLinearStepper.js" className="my-16" iframe={false} component={HorizontalLinearStepperComponent} raw={HorizontalLinearStepperRaw}/></Typography>
...
determine when all steps are completed (or even if they need to be completed).</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HorizontalNonLinearStepper.js" className="my-16" iframe={false} component={HorizontalNonLinearStepperComponent} raw={HorizontalNonLinearStepperRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HorizontalLinearAlternativeLabelStepper.js" className="my-16" iframe={false} component={HorizontalLinearAlternativeLabelStepperComponent} raw={HorizontalLinearAlternativeLabelStepperRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Error step</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HorizontalStepperWithError.js" className="my-16" iframe={false} component={HorizontalStepperWithErrorComponent} raw={HorizontalStepperWithErrorRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedSteppers.js" className="my-16" iframe={false} component={CustomizedSteppersComponent} raw={CustomizedSteppersRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VerticalLinearStepper.js" className="my-16" iframe={false} component={VerticalLinearStepperComponent} raw={VerticalLinearStepperRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TextMobileStepper.js" className="my-16" iframe={false} component={TextMobileStepperComponent} raw={TextMobileStepperRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SwipeableTextMobileStepper.js" className="my-16" iframe={false} component={SwipeableTextMobileStepperComponent} raw={SwipeableTextMobileStepperRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DotsMobileStepper.js" className="my-16" iframe={false} component={DotsMobileStepperComponent} raw={DotsMobileStepperRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ProgressMobileStepper.js" className="my-16" iframe={false} component={ProgressMobileStepperComponent} raw={ProgressMobileStepperRaw}/></Typography>
