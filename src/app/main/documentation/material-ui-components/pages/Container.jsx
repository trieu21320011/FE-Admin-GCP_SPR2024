...
function ContainerDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleContainer.js" className="my-16" iframe={true} component={SimpleContainerComponent} raw={SimpleContainerRaw}/></Typography>
...
The max-width matches the min-width of the current breakpoint.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FixedContainer.js" className="my-16" iframe={true} component={FixedContainerComponent} raw={FixedContainerRaw}/></Typography>
