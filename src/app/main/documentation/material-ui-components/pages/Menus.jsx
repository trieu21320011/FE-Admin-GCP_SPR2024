...
function MenusDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicMenu.js" className="my-16" iframe={false} component={BasicMenuComponent} raw={BasicMenuRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconMenu.js" className="my-16" iframe={false} component={IconMenuComponent} raw={IconMenuRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DenseMenu.js" className="my-16" iframe={false} component={DenseMenuComponent} raw={DenseMenuRaw}/></Typography>
...
To use a selected menu item without impacting the initial focus, set the <code>{`variant`}</code> prop to &quot;menu&quot;.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleListMenu.js" className="my-16" iframe={false} component={SimpleListMenuComponent} raw={SimpleListMenuRaw}/></Typography>
...
For instance, you can display the menu on top of the anchor:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PositionedMenu.js" className="my-16" iframe={false} component={PositionedMenuComponent} raw={PositionedMenuRaw}/></Typography>
...
For answering those needs, we expose a <code>{`MenuList`}</code> component that you can compose, with <code>{`Popper`}</code> in this example.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MenuListComposition.js" className="my-16" iframe={false} component={MenuListCompositionComponent} raw={MenuListCompositionRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AccountMenu.js" className="my-16" iframe={false} component={AccountMenuComponent} raw={AccountMenuRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedMenus.js" className="my-16" iframe={false} component={CustomizedMenusComponent} raw={CustomizedMenusRaw}/></Typography>
...
You can use the same list composition features with the <code>{`MenuItem`}</code> component:</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LongMenu.js" className="my-16" iframe={false} component={LongMenuComponent} raw={LongMenuRaw}/></Typography>
...
You can use the <code>{`Typography`}</code> component with <code>{`noWrap`}</code> to workaround this issue:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TypographyMenu.js" className="my-16" iframe={false} component={TypographyMenuComponent} raw={TypographyMenuRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FadeMenu.js" className="my-16" iframe={false} component={FadeMenuComponent} raw={FadeMenuRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ContextMenu.js" className="my-16" iframe={false} component={ContextMenuComponent} raw={ContextMenuRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MenuPopupState.js" className="my-16" iframe={false} component={MenuPopupStateComponent} raw={MenuPopupStateRaw}/></Typography>
