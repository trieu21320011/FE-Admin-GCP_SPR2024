...
The <code>{`ToggleButtonGroup`}</code> controls the selected state of its child buttons when given its own <code>{`value`}</code> prop.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ToggleButtons.js" className="my-16" iframe={false} component={ToggleButtonsComponent} raw={ToggleButtonsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ToggleButtonsMultiple.js" className="my-16" iframe={false} component={ToggleButtonsMultipleComponent} raw={ToggleButtonsMultipleRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ToggleButtonSizes.js" className="my-16" iframe={false} component={ToggleButtonSizesComponent} raw={ToggleButtonSizesRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Color</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorToggleButton.js" className="my-16" iframe={false} component={ColorToggleButtonComponent} raw={ColorToggleButtonRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VerticalToggleButtons.js" className="my-16" iframe={false} component={VerticalToggleButtonsComponent} raw={VerticalToggleButtonsRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ToggleButtonNotEmpty.js" className="my-16" iframe={false} component={ToggleButtonNotEmptyComponent} raw={ToggleButtonNotEmptyRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Standalone toggle button</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="StandaloneToggleButton.js" className="my-16" iframe={false} component={StandaloneToggleButtonComponent} raw={StandaloneToggleButtonRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedDividers.js" className="my-16" iframe={false} component={CustomizedDividersComponent} raw={CustomizedDividersRaw}/></Typography>
