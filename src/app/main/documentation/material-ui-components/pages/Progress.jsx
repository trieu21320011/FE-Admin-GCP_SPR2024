...
function ProgressDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CircularIndeterminate.js" className="my-16" iframe={false} component={CircularIndeterminateComponent} raw={CircularIndeterminateRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Circular color</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CircularColor.js" className="my-16" iframe={false} component={CircularColorComponent} raw={CircularColorRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Circular determinate</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CircularDeterminate.js" className="my-16" iframe={false} component={CircularDeterminateComponent} raw={CircularDeterminateRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Interactive integration</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CircularIntegration.js" className="my-16" iframe={false} component={CircularIntegrationComponent} raw={CircularIntegrationRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Circular with label</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CircularWithValueLabel.js" className="my-16" iframe={false} component={CircularWithValueLabelComponent} raw={CircularWithValueLabelRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LinearIndeterminate.js" className="my-16" iframe={false} component={LinearIndeterminateComponent} raw={LinearIndeterminateRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Linear color</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LinearColor.js" className="my-16" iframe={false} component={LinearColorComponent} raw={LinearColorRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Linear determinate</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LinearDeterminate.js" className="my-16" iframe={false} component={LinearDeterminateComponent} raw={LinearDeterminateRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Linear buffer</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LinearBuffer.js" className="my-16" iframe={false} component={LinearBufferComponent} raw={LinearBufferRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Linear with label</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LinearWithValueLabel.js" className="my-16" iframe={false} component={LinearWithValueLabelComponent} raw={LinearWithValueLabelRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedProgressBars.js" className="my-16" iframe={false} component={CustomizedProgressBarsComponent} raw={CustomizedProgressBarsRaw}/></Typography>
...
After 1.0 second, you can display a loader to keep user&#39;s flow of thought uninterrupted.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DelayingAppearance.js" className="my-16" iframe={false} component={DelayingAppearanceComponent} raw={DelayingAppearanceRaw}/></Typography>
...
See <a href="https://github.com/mui/material-ui/issues/10327">this issue</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CircularUnderLoad.js" className="my-16" iframe={false} component={CircularUnderLoadComponent} raw={CircularUnderLoadRaw}/></Typography>
