...
function AvatarsDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ImageAvatars.js" className="my-16" iframe={false} component={ImageAvatarsComponent} raw={ImageAvatarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LetterAvatars.js" className="my-16" iframe={false} component={LetterAvatarsComponent} raw={LetterAvatarsRaw}/></Typography>
...
The following demo generates the color based on the name of the person.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BackgroundLetterAvatars.js" className="my-16" iframe={false} component={BackgroundLetterAvatarsComponent} raw={BackgroundLetterAvatarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SizeAvatars.js" className="my-16" iframe={false} component={SizeAvatarsComponent} raw={SizeAvatarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconAvatars.js" className="my-16" iframe={false} component={IconAvatarsComponent} raw={IconAvatarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VariantAvatars.js" className="my-16" iframe={false} component={VariantAvatarsComponent} raw={VariantAvatarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FallbackAvatars.js" className="my-16" iframe={false} component={FallbackAvatarsComponent} raw={FallbackAvatarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="GroupAvatars.js" className="my-16" iframe={false} component={GroupAvatarsComponent} raw={GroupAvatarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TotalAvatars.js" className="my-16" iframe={false} component={TotalAvatarsComponent} raw={TotalAvatarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomSurplusAvatars.js" className="my-16" iframe={false} component={CustomSurplusAvatarsComponent} raw={CustomSurplusAvatarsRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">With badge</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BadgeAvatars.js" className="my-16" iframe={false} component={BadgeAvatarsComponent} raw={BadgeAvatarsRaw}/></Typography>
