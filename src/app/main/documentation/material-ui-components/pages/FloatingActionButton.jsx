...
Only one component is recommended per screen to represent the most common action.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FloatingActionButtons.js" className="my-16" iframe={false} component={FloatingActionButtonsComponent} raw={FloatingActionButtonsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FloatingActionButtonSize.js" className="my-16" iframe={false} component={FloatingActionButtonSizeComponent} raw={FloatingActionButtonSizeRaw}/>
    <FuseExample name="FloatingActionButtonExtendedSize.js" className="my-16" iframe={false} component={FloatingActionButtonExtendedSizeComponent} raw={FloatingActionButtonExtendedSizeRaw}/></Typography>
...
animation to finish before the new one enters.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FloatingActionButtonZoom.js" className="my-16" iframe={false} component={FloatingActionButtonZoomComponent} raw={FloatingActionButtonZoomRaw}/></Typography>
