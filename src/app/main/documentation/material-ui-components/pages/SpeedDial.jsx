...
function SpeedDialDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicSpeedDial.js" className="my-16" iframe={false} component={BasicSpeedDialComponent} raw={BasicSpeedDialRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Playground</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PlaygroundSpeedDial.js" className="my-16" iframe={false} component={PlaygroundSpeedDialComponent} raw={PlaygroundSpeedDialRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ControlledOpenSpeedDial.js" className="my-16" iframe={false} component={ControlledOpenSpeedDialComponent} raw={ControlledOpenSpeedDialRaw}/></Typography>
...
of the <code>{`SpeedDialIcon`}</code> component.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="OpenIconSpeedDial.js" className="my-16" iframe={false} component={OpenIconSpeedDialComponent} raw={OpenIconSpeedDialRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SpeedDialTooltipOpen.js" className="my-16" iframe={false} component={SpeedDialTooltipOpenComponent} raw={SpeedDialTooltipOpenRaw}/></Typography>
