...
If a row is already filled with the specified number of columns, the next item starts another row, and it is added to the shortest column in order to optimize the use of space.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicMasonry.js" className="my-16" iframe={false} component={BasicMasonryComponent} raw={BasicMasonryRaw}/></Typography>
...
If you&#39;d like to order images by column, check out <a href="/material-ui/react-image-list/#masonry-image-list">ImageList</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ImageMasonry.js" className="my-16" iframe={false} component={ImageMasonryComponent} raw={ImageMasonryRaw}/></Typography>
...
Items can move to other columns in order to abide by the rule that items are always added to the shortest column and hence optimize the use of space.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MasonryWithVariableHeightItems.js" className="my-16" iframe={false} component={MasonryWithVariableHeightItemsComponent} raw={MasonryWithVariableHeightItemsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FixedColumns.js" className="my-16" iframe={false} component={FixedColumnsComponent} raw={FixedColumnsRaw}/></Typography>
    <Typography className="text-14 mb-32" component="div"><code>{`columns`}</code> accepts responsive values:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ResponsiveColumns.js" className="my-16" iframe={false} component={ResponsiveColumnsComponent} raw={ResponsiveColumnsRaw}/></Typography>
...
It is important to note that the value provided to the <code>{`spacing`}</code> prop is multiplied by the theme&#39;s spacing field.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FixedSpacing.js" className="my-16" iframe={false} component={FixedSpacingComponent} raw={FixedSpacingRaw}/></Typography>
    <Typography className="text-14 mb-32" component="div"><code>{`spacing`}</code> accepts responsive values:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ResponsiveSpacing.js" className="my-16" iframe={false} component={ResponsiveSpacingComponent} raw={ResponsiveSpacingRaw}/></Typography>
...
support server-side rendering.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SSRMasonry.js" className="my-16" iframe={false} component={SSRMasonryComponent} raw={SSRMasonryRaw}/></Typography>
