...
function BottomNavigationDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleBottomNavigation.js" className="my-16" iframe={false} component={SimpleBottomNavigationComponent} raw={SimpleBottomNavigationRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LabelBottomNavigation.js" className="my-16" iframe={false} component={LabelBottomNavigationComponent} raw={LabelBottomNavigationRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FixedBottomNavigation.js" className="my-16" iframe={true} component={FixedBottomNavigationComponent} raw={FixedBottomNavigationRaw}/></Typography>
