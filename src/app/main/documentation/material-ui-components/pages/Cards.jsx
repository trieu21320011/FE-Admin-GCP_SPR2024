...
The Material UI Card component includes several complementary utility components to handle various use cases:</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicCard.js" className="my-16" iframe={false} component={BasicCardComponent} raw={BasicCardRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="OutlinedCard.js" className="my-16" iframe={false} component={OutlinedCardComponent} raw={OutlinedCardRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RecipeReviewCard.js" className="my-16" iframe={false} component={RecipeReviewCardComponent} raw={RecipeReviewCardRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MediaCard.js" className="my-16" iframe={false} component={MediaCardComponent} raw={MediaCardRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ImgMediaCard.js" className="my-16" iframe={false} component={ImgMediaCardComponent} raw={ImgMediaCardRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ActionAreaCard.js" className="my-16" iframe={false} component={ActionAreaCardComponent} raw={ActionAreaCardRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MultiActionAreaCard.js" className="my-16" iframe={false} component={MultiActionAreaCardComponent} raw={MultiActionAreaCardRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MediaControlCard.js" className="my-16" iframe={false} component={MediaControlCardComponent} raw={MediaControlCardRaw}/></Typography>
