...
function TableDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicTable.js" className="my-16" iframe={false} component={BasicTableComponent} raw={BasicTableRaw}/></Typography>
...
While it comes with a more rigid structure, in exchange, you gain more powerful features.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DataTable.js" className="my-16" iframe={false} component={DataTableComponent} raw={DataTableRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DenseTable.js" className="my-16" iframe={false} component={DenseTableComponent} raw={DenseTableRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="EnhancedTable.js" className="my-16" iframe={false} component={EnhancedTableComponent} raw={EnhancedTableRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedTables.js" className="my-16" iframe={false} component={CustomizedTablesComponent} raw={CustomizedTablesRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomPaginationActionsTable.js" className="my-16" iframe={false} component={CustomPaginationActionsTableComponent} raw={CustomPaginationActionsTableRaw}/></Typography>
...
(⚠️ no IE 11 support)</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="StickyHeadTable.js" className="my-16" iframe={false} component={StickyHeadTableComponent} raw={StickyHeadTableRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColumnGroupingTable.js" className="my-16" iframe={false} component={ColumnGroupingTableComponent} raw={ColumnGroupingTableRaw}/></Typography>
...
It utilizes the <a href="/material-ui/api/collapse/"><code>{`Collapse`}</code></a> component.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CollapsibleTable.js" className="my-16" iframe={false} component={CollapsibleTableComponent} raw={CollapsibleTableRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SpanningTable.js" className="my-16" iframe={false} component={SpanningTableComponent} raw={SpanningTableRaw}/></Typography>
...
Virtualization helps with performance issues.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ReactVirtualizedTable.js" className="my-16" iframe={false} component={ReactVirtualizedTableComponent} raw={ReactVirtualizedTableRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AccessibleTable.js" className="my-16" iframe={false} component={AccessibleTableComponent} raw={AccessibleTableRaw}/></Typography>
