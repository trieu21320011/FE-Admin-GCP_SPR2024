...
function AlertDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleAlert.js" className="my-16" iframe={false} component={SimpleAlertComponent} raw={SimpleAlertRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicAlerts.js" className="my-16" iframe={false} component={BasicAlertsComponent} raw={BasicAlertsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FilledAlerts.js" className="my-16" iframe={false} component={FilledAlertsComponent} raw={FilledAlertsRaw}/></Typography>
    <Typography className="text-14 mt-12 mb-10" component="h4">Outlined</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="OutlinedAlerts.js" className="my-16" iframe={false} component={OutlinedAlertsComponent} raw={OutlinedAlertsRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorAlerts.js" className="my-16" iframe={false} component={ColorAlertsComponent} raw={ColorAlertsRaw}/></Typography>
...
This lets you insert any element—an HTML tag, an SVG icon, or a React component such as a Material UI Button—after the Alert&#39;s message, justified to the right.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ActionAlerts.js" className="my-16" iframe={false} component={ActionAlertsComponent} raw={ActionAlertsRaw}/></Typography>
...
You can define this prop globally by customizing your app&#39;s theme. See <a href="/material-ui/customization/theme-components/#theme-default-props">Theme components—Default props</a> for details.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IconAlerts.js" className="my-16" iframe={false} component={IconAlertsComponent} raw={IconAlertsRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DescriptionAlerts.js" className="my-16" iframe={false} component={DescriptionAlertsComponent} raw={DescriptionAlertsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TransitionAlerts.js" className="my-16" iframe={false} component={TransitionAlertsComponent} raw={TransitionAlertsRaw}/></Typography>
