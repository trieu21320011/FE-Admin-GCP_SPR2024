...
function RatingDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicRating.js" className="my-16" iframe={false} component={BasicRatingComponent} raw={BasicRatingRaw}/></Typography>
...
Use the <code>{`precision`}</code> prop to define the minimum increment value change allowed.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HalfRating.js" className="my-16" iframe={false} component={HalfRatingComponent} raw={HalfRatingRaw}/></Typography>
...
The demo uses the <code>{`onChangeActive`}</code> prop.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HoverRating.js" className="my-16" iframe={false} component={HoverRatingComponent} raw={HoverRatingRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RatingSize.js" className="my-16" iframe={false} component={RatingSizeComponent} raw={RatingSizeRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedRating.js" className="my-16" iframe={false} component={CustomizedRatingComponent} raw={CustomizedRatingRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RadioGroupRating.js" className="my-16" iframe={false} component={RadioGroupRatingComponent} raw={RadioGroupRatingRaw}/></Typography>
...
By default, the rating component uses both a difference of color and shape (filled and empty icons) to indicate the value. In the event that you are using color as the only means to indicate the value, the information should also be also displayed as text, as in this demo. This is important to match <a href="https://www.w3.org/TR/WCAG21/#use-of-color">success Criterion 1.4.1</a> of WCAG2.1.</li>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TextRating.js" className="my-16" iframe={false} component={TextRatingComponent} raw={TextRatingRaw}/></Typography>
