...
function LinksDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Links.js" className="my-16" iframe={false} component={LinksComponent} raw={LinksRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="UnderlineLink.js" className="my-16" iframe={false} component={UnderlineLinkComponent} raw={UnderlineLinkRaw}/></Typography>
...
The demo below illustrates how to properly link with a <code>{`<button>`}</code>:</li>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ButtonLink.js" className="my-16" iframe={false} component={ButtonLinkComponent} raw={ButtonLinkRaw}/></Typography>
