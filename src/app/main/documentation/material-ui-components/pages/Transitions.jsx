...
The <code>{`collapsedSize`}</code> prop can be used to set the minimum width/height when not expanded.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleCollapse.js" className="my-16" iframe={false} component={SimpleCollapseComponent} raw={SimpleCollapseRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleFade.js" className="my-16" iframe={false} component={SimpleFadeComponent} raw={SimpleFadeRaw}/></Typography>
...
the <code>{`timeout`}</code> prop to change the entry speed.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleGrow.js" className="my-16" iframe={false} component={SimpleGrowComponent} raw={SimpleGrowRaw}/></Typography>
...
Similarly, the <code>{`unmountOnExit`}</code> prop removes the component from the DOM after it has been transition off-screen.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleSlide.js" className="my-16" iframe={false} component={SimpleSlideComponent} raw={SimpleSlideRaw}/></Typography>
...
If this prop is set, the Slide component will slide from the edge of that DOM node.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SlideFromContainer.js" className="my-16" iframe={false} component={SlideFromContainerComponent} raw={SlideFromContainerRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleZoom.js" className="my-16" iframe={false} component={SimpleZoomComponent} raw={SimpleZoomRaw}/></Typography>
...
As components are added or removed, the <code>{`in`}</code> prop is toggled automatically by <code>{`TransitionGroup`}</code>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TransitionGroupExample.js" className="my-16" iframe={false} component={TransitionGroupExampleComponent} raw={TransitionGroupExampleRaw}/></Typography>
