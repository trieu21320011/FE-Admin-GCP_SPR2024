...
should be made clear from the corresponding inline label.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicSwitches.js" className="my-16" iframe={false} component={BasicSwitchesComponent} raw={BasicSwitchesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SwitchLabels.js" className="my-16" iframe={false} component={SwitchLabelsComponent} raw={SwitchLabelsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SwitchesSize.js" className="my-16" iframe={false} component={SwitchesSizeComponent} raw={SwitchesSizeRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Color</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorSwitches.js" className="my-16" iframe={false} component={ColorSwitchesComponent} raw={ColorSwitchesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ControlledSwitches.js" className="my-16" iframe={false} component={ControlledSwitchesComponent} raw={ControlledSwitchesRaw}/></Typography>
...
However, you are encouraged to use <a href="/material-ui/react-checkbox/">Checkboxes</a> instead if multiple related controls are required. (See: <a href="#when-to-use">When to use</a>).</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SwitchesGroup.js" className="my-16" iframe={false} component={SwitchesGroupComponent} raw={SwitchesGroupRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedSwitches.js" className="my-16" iframe={false} component={CustomizedSwitchesComponent} raw={CustomizedSwitchesRaw}/></Typography>
