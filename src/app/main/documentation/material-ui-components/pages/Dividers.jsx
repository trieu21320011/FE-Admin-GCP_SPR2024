...
function DividersDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IntroDivider.js" className="my-16" iframe={false} component={IntroDividerComponent} raw={IntroDividerRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DividerVariants.js" className="my-16" iframe={false} component={DividerVariantsComponent} raw={DividerVariantsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VerticalDividers.js" className="my-16" iframe={false} component={VerticalDividersComponent} raw={VerticalDividersRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FlexDivider.js" className="my-16" iframe={false} component={FlexDividerComponent} raw={FlexDividerRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DividerText.js" className="my-16" iframe={false} component={DividerTextComponent} raw={DividerTextRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ListDividers.js" className="my-16" iframe={false} component={ListDividersComponent} raw={ListDividersRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VerticalDividerMiddle.js" className="my-16" iframe={false} component={VerticalDividerMiddleComponent} raw={VerticalDividerMiddleRaw}/></Typography>
