...
function AppBarDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ButtonAppBar.js" className="my-16" iframe={false} component={ButtonAppBarComponent} raw={ButtonAppBarRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">App bar with menu</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MenuAppBar.js" className="my-16" iframe={false} component={MenuAppBarComponent} raw={MenuAppBarRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">App bar with responsive menu</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ResponsiveAppBar.js" className="my-16" iframe={false} component={ResponsiveAppBarComponent} raw={ResponsiveAppBarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SearchAppBar.js" className="my-16" iframe={false} component={SearchAppBarComponent} raw={SearchAppBarRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Responsive App bar with Drawer</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DrawerAppBar.js" className="my-16" iframe={true} component={DrawerAppBarComponent} raw={DrawerAppBarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PrimarySearchAppBar.js" className="my-16" iframe={false} component={PrimarySearchAppBarComponent} raw={PrimarySearchAppBarRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Dense (desktop only)</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DenseAppBar.js" className="my-16" iframe={false} component={DenseAppBarComponent} raw={DenseAppBarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ProminentAppBar.js" className="my-16" iframe={false} component={ProminentAppBarComponent} raw={ProminentAppBarRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Bottom App bar</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BottomAppBar.js" className="my-16" iframe={true} component={BottomAppBarComponent} raw={BottomAppBarRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HideAppBar.js" className="my-16" iframe={true} component={HideAppBarComponent} raw={HideAppBarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ElevateAppBar.js" className="my-16" iframe={true} component={ElevateAppBarComponent} raw={ElevateAppBarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BackToTop.js" className="my-16" iframe={true} component={BackToTopComponent} raw={BackToTopRaw}/></Typography>
...
You can override this behavior by setting the <code>{`enableColorOnDark`}</code> prop to <code>{`true`}</code>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="EnableColorOnDarkAppBar.js" className="my-16" iframe={false} component={EnableColorOnDarkAppBarComponent} raw={EnableColorOnDarkAppBarRaw}/></Typography>
