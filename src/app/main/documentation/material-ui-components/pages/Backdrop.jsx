...
After clicking <strong>Show Backdrop</strong>, you can click anywhere on the page to close it.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleBackdrop.js" className="my-16" iframe={false} component={SimpleBackdropComponent} raw={SimpleBackdropRaw}/></Typography>
