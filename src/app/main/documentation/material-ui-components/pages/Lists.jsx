...
function ListsDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicList.js" className="my-16" iframe={false} component={BasicListComponent} raw={BasicListRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="NestedList.js" className="my-16" iframe={false} component={NestedListComponent} raw={NestedListRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Folder List</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FolderList.js" className="my-16" iframe={false} component={FolderListComponent} raw={FolderListRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="InteractiveList.js" className="my-16" iframe={false} component={InteractiveListComponent} raw={InteractiveListRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Selected ListItem</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SelectedListItem.js" className="my-16" iframe={false} component={SelectedListItemComponent} raw={SelectedListItemRaw}/></Typography>
...
You should set the <code>{`alignItems="flex-start"`}</code> prop to align the avatar at the top, following the Material Design guidelines:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AlignItemsList.js" className="my-16" iframe={false} component={AlignItemsListComponent} raw={AlignItemsListRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CheckboxList.js" className="my-16" iframe={false} component={CheckboxListComponent} raw={CheckboxListRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CheckboxListSecondary.js" className="my-16" iframe={false} component={CheckboxListSecondaryComponent} raw={CheckboxListSecondaryRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SwitchListSecondary.js" className="my-16" iframe={false} component={SwitchListSecondaryComponent} raw={SwitchListSecondaryRaw}/></Typography>
...
(⚠️ no IE 11 support)</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PinnedSubheaderList.js" className="my-16" iframe={false} component={PinnedSubheaderListComponent} raw={PinnedSubheaderListRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="InsetList.js" className="my-16" iframe={false} component={InsetListComponent} raw={InsetListRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="GutterlessList.js" className="my-16" iframe={false} component={GutterlessListComponent} raw={GutterlessListRaw}/></Typography>
...
Virtualization helps with performance issues.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VirtualizedList.js" className="my-16" iframe={false} component={VirtualizedListComponent} raw={VirtualizedListRaw}/></Typography>
...
You can learn more about this in the
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedList.js" className="my-16" iframe={false} component={CustomizedListComponent} raw={CustomizedListRaw}/></Typography>
