...
The demo below, inspired by Google Keep, shows a basic Snackbar with a text element and two actions:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleSnackbar.js" className="my-16" iframe={false} component={SimpleSnackbarComponent} raw={SimpleSnackbarRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PositionedSnackbar.js" className="my-16" iframe={false} component={PositionedSnackbarComponent} raw={PositionedSnackbarRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LongTextSnackbar.js" className="my-16" iframe={false} component={LongTextSnackbarComponent} raw={LongTextSnackbarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AutohideSnackbar.js" className="my-16" iframe={false} component={AutohideSnackbarComponent} raw={AutohideSnackbarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TransitionsSnackbar.js" className="my-16" iframe={false} component={TransitionsSnackbarComponent} raw={TransitionsSnackbarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedSnackbars.js" className="my-16" iframe={false} component={CustomizedSnackbarsComponent} raw={CustomizedSnackbarsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FabIntegrationSnackbar.js" className="my-16" iframe={true} component={FabIntegrationSnackbarComponent} raw={FabIntegrationSnackbarRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ConsecutiveSnackbars.js" className="my-16" iframe={false} component={ConsecutiveSnackbarsComponent} raw={ConsecutiveSnackbarsRaw}/></Typography>
...
Even though this is discouraged in the Material Design guidelines, it is still a common pattern.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="IntegrationNotistack.js" className="my-16" iframe={false} component={IntegrationNotistackComponent} raw={IntegrationNotistackRaw}/></Typography>
