...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Types.js" className="my-16" iframe={false} component={TypesComponent} raw={TypesRaw}/></Typography>
...
Hopefully, you might be able to take advantage of the <a href="/material-ui/customization/default-theme/?expand-path=$.typography"><code>{`typography`}</code></a> keys of the theme.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TypographyTheme.js" className="my-16" iframe={false} component={TypographyThemeComponent} raw={TypographyThemeRaw}/></Typography>
