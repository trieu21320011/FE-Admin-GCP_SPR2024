...
function SelectsDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicSelect.js" className="my-16" iframe={false} component={BasicSelectComponent} raw={BasicSelectRaw}/></Typography>
...
It shares the same styles and many of the same props. Refer to the respective component&#39;s API page for details.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SelectVariants.js" className="my-16" iframe={false} component={SelectVariantsComponent} raw={SelectVariantsRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Labels and helper text</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SelectLabels.js" className="my-16" iframe={false} component={SelectLabelsComponent} raw={SelectLabelsRaw}/></Typography>
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SelectAutoWidth.js" className="my-16" iframe={false} component={SelectAutoWidthComponent} raw={SelectAutoWidthRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Small Size</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SelectSmall.js" className="my-16" iframe={false} component={SelectSmallComponent} raw={SelectSmallRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Other props</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SelectOtherProps.js" className="my-16" iframe={false} component={SelectOtherPropsComponent} raw={SelectOtherPropsRaw}/></Typography>
...
we allow such pattern.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="NativeSelectDemo.js" className="my-16" iframe={false} component={NativeSelectDemoComponent} raw={NativeSelectDemoRaw}/></Typography>
...
Notice that the <code>{`"standard"`}</code> variant is easier to customize, since it does not wrap the contents in a <code>{`fieldset`}</code>/<code>{`legend`}</code> markup.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedSelects.js" className="my-16" iframe={false} component={CustomizedSelectsComponent} raw={CustomizedSelectsRaw}/></Typography>
...
It&#39;s enabled with the <code>{`multiple`}</code> prop.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MultipleSelect.js" className="my-16" iframe={false} component={MultipleSelectComponent} raw={MultipleSelectRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Checkmarks</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MultipleSelectCheckmarks.js" className="my-16" iframe={false} component={MultipleSelectCheckmarksComponent} raw={MultipleSelectCheckmarksRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Chip</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MultipleSelectChip.js" className="my-16" iframe={false} component={MultipleSelectChipComponent} raw={MultipleSelectChipRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Placeholder</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MultipleSelectPlaceholder.js" className="my-16" iframe={false} component={MultipleSelectPlaceholderComponent} raw={MultipleSelectPlaceholderRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Native</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MultipleSelectNative.js" className="my-16" iframe={false} component={MultipleSelectNativeComponent} raw={MultipleSelectNativeRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ControlledOpenSelect.js" className="my-16" iframe={false} component={ControlledOpenSelectComponent} raw={ControlledOpenSelectRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DialogSelect.js" className="my-16" iframe={false} component={DialogSelectComponent} raw={DialogSelectRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="GroupedSelect.js" className="my-16" iframe={false} component={GroupedSelectComponent} raw={GroupedSelectRaw}/></Typography>
    <Typography className="text-14 mb-32" component="div">:::warning
