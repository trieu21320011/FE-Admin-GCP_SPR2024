...
For example, a component with <code>{`xs={12}`}</code> occupies the whole viewport width regardless of its size.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicGrid.js" className="my-16" iframe={false} component={BasicGridComponent} raw={BasicGridRaw}/></Typography>
...
When the viewport grows beyond this size, the component occupies half of the total width—six columns rather than 12.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FullWidthGrid.js" className="my-16" iframe={false} component={FullWidthGridComponent} raw={FullWidthGridRaw}/></Typography>
...
The prop is converted into a CSS property using the <a href="/material-ui/customization/spacing/"><code>{`theme.spacing()`}</code></a> helper.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SpacingGrid.js" className="my-16" iframe={false} component={SpacingGridComponent} raw={SpacingGridRaw}/></Typography>
...
They behave similarly to the <code>{`row-gap`}</code> and <code>{`column-gap`}</code> properties of <a href="/system/grid/#row-gap-amp-column-gap">CSS Grid</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RowAndColumnSpacing.js" className="my-16" iframe={false} component={RowAndColumnSpacingComponent} raw={RowAndColumnSpacingRaw}/></Typography>
...
For instance, we can implement Material Design&#39;s <a href="https://m2.material.io/design/layout/responsive-layout-grid.html">recommended</a> responsive layout grid, as seen in the following demo:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ResponsiveGrid.js" className="my-16" iframe={false} component={ResponsiveGridComponent} raw={ResponsiveGridRaw}/></Typography>
...
When you set the width of one item, the others will automatically resize to match it.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AutoGrid.js" className="my-16" iframe={false} component={AutoGridComponent} raw={AutoGridRaw}/></Typography>
...
The demo below shows how this works:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VariableWidthGrid.js" className="my-16" iframe={false} component={VariableWidthGridComponent} raw={VariableWidthGridRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="NestedGrid.js" className="my-16" iframe={false} component={NestedGridComponent} raw={NestedGridRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="NestedGridColumns.js" className="my-16" iframe={false} component={NestedGridColumnsComponent} raw={NestedGridColumnsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColumnsGrid.js" className="my-16" iframe={false} component={ColumnsGridComponent} raw={ColumnsGridRaw}/></Typography>
...
These props accept:</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="OffsetGrid.js" className="my-16" iframe={false} component={OffsetGridComponent} raw={OffsetGridRaw}/></Typography>
...
This removes the negative margins from the bottom and right sides of the grid to prevent overflow.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="OverflowGrid.js" className="my-16" iframe={false} component={OverflowGridComponent} raw={OverflowGridRaw}/></Typography>
    <Typography className="text-14 mb-32" component="div">:::warning
...
Then use <code>{`justifyContent`}</code> and/or <code>{`alignItems`}</code> to adjust the position of the content, as shown below:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CenteredElementGrid.js" className="my-16" iframe={false} component={CenteredElementGridComponent} raw={CenteredElementGridRaw}/></Typography>
    <Typography className="text-14 mb-32" component="div">:::warning
...
:::</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FullBorderedGrid.js" className="my-16" iframe={false} component={FullBorderedGridComponent} raw={FullBorderedGridRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Half border</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HalfBorderedGrid.js" className="my-16" iframe={false} component={HalfBorderedGridComponent} raw={HalfBorderedGridRaw}/></Typography>
