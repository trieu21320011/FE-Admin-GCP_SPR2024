...
function SliderDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ContinuousSlider.js" className="my-16" iframe={false} component={ContinuousSliderComponent} raw={ContinuousSliderRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SliderSizes.js" className="my-16" iframe={false} component={SliderSizesComponent} raw={SliderSizesRaw}/></Typography>
...
You can generate a mark for each step with <code>{`marks={true}`}</code>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DiscreteSlider.js" className="my-16" iframe={false} component={DiscreteSliderComponent} raw={DiscreteSliderRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DiscreteSliderSteps.js" className="my-16" iframe={false} component={DiscreteSliderStepsComponent} raw={DiscreteSliderStepsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DiscreteSliderMarks.js" className="my-16" iframe={false} component={DiscreteSliderMarksComponent} raw={DiscreteSliderMarksRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DiscreteSliderValues.js" className="my-16" iframe={false} component={DiscreteSliderValuesComponent} raw={DiscreteSliderValuesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DiscreteSliderLabel.js" className="my-16" iframe={false} component={DiscreteSliderLabelComponent} raw={DiscreteSliderLabelRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RangeSlider.js" className="my-16" iframe={false} component={RangeSliderComponent} raw={RangeSliderRaw}/></Typography>
...
If you want the range to shift when reaching minimum distance, you can utilize the <code>{`activeThumb`}</code> parameter in <code>{`onChange`}</code>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MinimumDistanceSlider.js" className="my-16" iframe={false} component={MinimumDistanceSliderComponent} raw={MinimumDistanceSliderRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="InputSlider.js" className="my-16" iframe={false} component={InputSliderComponent} raw={InputSliderRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Color</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorSlider.js" className="my-16" iframe={false} component={ColorSliderComponent} raw={ColorSliderRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedSlider.js" className="my-16" iframe={false} component={CustomizedSliderComponent} raw={CustomizedSliderRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Music player</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MusicPlayerSlider.js" className="my-16" iframe={false} component={MusicPlayerSliderComponent} raw={MusicPlayerSliderRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Vertical sliders</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VerticalSlider.js" className="my-16" iframe={false} component={VerticalSliderComponent} raw={VerticalSliderRaw}/></Typography>
...
This might be less confusing to users compared to a change in direction.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VerticalAccessibleSlider.js" className="my-16" iframe={false} component={VerticalAccessibleSliderComponent} raw={VerticalAccessibleSliderRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TrackFalseSlider.js" className="my-16" iframe={false} component={TrackFalseSliderComponent} raw={TrackFalseSliderRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TrackInvertedSlider.js" className="my-16" iframe={false} component={TrackInvertedSliderComponent} raw={TrackInvertedSliderRaw}/></Typography>
...
Increasing <em>x</em> by one increases the represented value by factor <em>2</em>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="NonLinearSlider.js" className="my-16" iframe={false} component={NonLinearSliderComponent} raw={NonLinearSliderRaw}/></Typography>
