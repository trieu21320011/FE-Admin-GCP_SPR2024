...
If available options can be collapsed, consider using a <a href="/material-ui/react-select/">Select component</a> because it uses less space.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RadioButtonsGroup.js" className="my-16" iframe={false} component={RadioButtonsGroupComponent} raw={RadioButtonsGroupRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RowRadioButtonsGroup.js" className="my-16" iframe={false} component={RowRadioButtonsGroupComponent} raw={RowRadioButtonsGroupRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ControlledRadioButtonsGroup.js" className="my-16" iframe={false} component={ControlledRadioButtonsGroupComponent} raw={ControlledRadioButtonsGroupRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RadioButtons.js" className="my-16" iframe={false} component={RadioButtonsComponent} raw={RadioButtonsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SizeRadioButtons.js" className="my-16" iframe={false} component={SizeRadioButtonsComponent} raw={SizeRadioButtonsRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Color</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorRadioButtons.js" className="my-16" iframe={false} component={ColorRadioButtonsComponent} raw={ColorRadioButtonsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FormControlLabelPlacement.js" className="my-16" iframe={false} component={FormControlLabelPlacementComponent} raw={FormControlLabelPlacementRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ErrorRadios.js" className="my-16" iframe={false} component={ErrorRadiosComponent} raw={ErrorRadiosRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedRadios.js" className="my-16" iframe={false} component={CustomizedRadiosComponent} raw={CustomizedRadiosRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="UseRadioGroup.js" className="my-16" iframe={false} component={UseRadioGroupComponent} raw={UseRadioGroupRaw}/></Typography>
