...
function TimelineDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicTimeline.js" className="my-16" iframe={false} component={BasicTimelineComponent} raw={BasicTimelineRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LeftPositionedTimeline.js" className="my-16" iframe={false} component={LeftPositionedTimelineComponent} raw={LeftPositionedTimelineRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AlternateTimeline.js" className="my-16" iframe={false} component={AlternateTimelineComponent} raw={AlternateTimelineRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AlternateReverseTimeline.js" className="my-16" iframe={false} component={AlternateReverseTimelineComponent} raw={AlternateReverseTimelineRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorsTimeline.js" className="my-16" iframe={false} component={ColorsTimelineComponent} raw={ColorsTimelineRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Outlined</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="OutlinedTimeline.js" className="my-16" iframe={false} component={OutlinedTimelineComponent} raw={OutlinedTimelineRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="OppositeContentTimeline.js" className="my-16" iframe={false} component={OppositeContentTimelineComponent} raw={OppositeContentTimelineRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedTimeline.js" className="my-16" iframe={false} component={CustomizedTimelineComponent} raw={CustomizedTimelineRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LeftAlignedTimeline.js" className="my-16" iframe={false} component={LeftAlignedTimelineComponent} raw={LeftAlignedTimelineRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Right-aligned</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="RightAlignedTimeline.js" className="my-16" iframe={false} component={RightAlignedTimelineComponent} raw={RightAlignedTimelineRaw}/></Typography>
    <Typography className="text-16 mt-20 mb-10 font-700" component="h3">Left-aligned with no opposite content</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="NoOppositeContent.js" className="my-16" iframe={false} component={NoOppositeContentComponent} raw={NoOppositeContentRaw}/></Typography>
