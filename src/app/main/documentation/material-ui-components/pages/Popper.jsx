...
If you need this behavior, you can use <a href="/material-ui/react-click-away-listener/"><code>{`ClickAwayListener`}</code></a> - see the example in the <a href="/material-ui/react-menu/#menulist-composition">menu documentation section</a>.</li>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimplePopper.js" className="my-16" iframe={false} component={SimplePopperComponent} raw={SimplePopperRaw}/></Typography>
...
These two callbacks allow the popper to unmount the child content when closed and fully transitioned.</li>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TransitionsPopper.js" className="my-16" iframe={false} component={TransitionsPopperComponent} raw={TransitionsPopperRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SpringPopper.js" className="my-16" iframe={false} component={SpringPopperComponent} raw={SpringPopperRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Positioned popper</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PositionedPopper.js" className="my-16" iframe={false} component={PositionedPopperComponent} raw={PositionedPopperRaw}/></Typography>
...
You need to create an object shaped like the <a href="https://popper.js.org/docs/v2/virtual-elements/"><code>{`VirtualElement`}</code></a>.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VirtualElementPopper.js" className="my-16" iframe={false} component={VirtualElementPopperComponent} raw={VirtualElementPopperRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PopperPopupState.js" className="my-16" iframe={false} component={PopperPopupStateComponent} raw={PopperPopupStateRaw}/></Typography>
