...
function TabsDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicTabs.js" className="my-16" iframe={false} component={BasicTabsComponent} raw={BasicTabsRaw}/></Typography>
