...
function PaginationDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicPagination.js" className="my-16" iframe={false} component={BasicPaginationComponent} raw={BasicPaginationRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Outlined pagination</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PaginationOutlined.js" className="my-16" iframe={false} component={PaginationOutlinedComponent} raw={PaginationOutlinedRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Rounded pagination</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PaginationRounded.js" className="my-16" iframe={false} component={PaginationRoundedComponent} raw={PaginationRoundedRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Pagination size</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PaginationSize.js" className="my-16" iframe={false} component={PaginationSizeComponent} raw={PaginationSizeRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PaginationButtons.js" className="my-16" iframe={false} component={PaginationButtonsComponent} raw={PaginationButtonsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomIcons.js" className="my-16" iframe={false} component={CustomIconsComponent} raw={CustomIconsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PaginationRanges.js" className="my-16" iframe={false} component={PaginationRangesComponent} raw={PaginationRangesRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Controlled pagination</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PaginationControlled.js" className="my-16" iframe={false} component={PaginationControlledComponent} raw={PaginationControlledRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="UsePagination.js" className="my-16" iframe={false} component={UsePaginationComponent} raw={UsePaginationRaw}/></Typography>
...
It&#39;s preferred in contexts where SEO is important, for instance, a blog.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TablePaginationDemo.js" className="my-16" iframe={false} component={TablePaginationDemoComponent} raw={TablePaginationDemoRaw}/></Typography>
