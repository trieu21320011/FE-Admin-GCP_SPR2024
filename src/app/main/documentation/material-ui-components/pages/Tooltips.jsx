...
function TooltipsDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicTooltip.js" className="my-16" iframe={false} component={BasicTooltipComponent} raw={BasicTooltipRaw}/></Typography>
...
They don&#39;t have directional arrows; instead, they rely on motion emanating from the source to convey direction.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="PositionedTooltips.js" className="my-16" iframe={false} component={PositionedTooltipsComponent} raw={PositionedTooltipsRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedTooltips.js" className="my-16" iframe={false} component={CustomizedTooltipsComponent} raw={CustomizedTooltipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ArrowTooltips.js" className="my-16" iframe={false} component={ArrowTooltipsComponent} raw={ArrowTooltipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TooltipOffset.js" className="my-16" iframe={false} component={TooltipOffsetComponent} raw={TooltipOffsetRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TooltipMargin.js" className="my-16" iframe={false} component={TooltipMarginComponent} raw={TooltipMarginRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TriggersTooltips.js" className="my-16" iframe={false} component={TriggersTooltipsComponent} raw={TriggersTooltipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ControlledTooltips.js" className="my-16" iframe={false} component={ControlledTooltipsComponent} raw={ControlledTooltipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="VariableWidth.js" className="my-16" iframe={false} component={VariableWidthComponent} raw={VariableWidthRaw}/></Typography>
...
You can disable this behavior (thus failing the success criterion which is required to reach level AA) by passing <code>{`disableInteractive`}</code>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="NonInteractiveTooltips.js" className="my-16" iframe={false} component={NonInteractiveTooltipsComponent} raw={NonInteractiveTooltipsRaw}/></Typography>
...
:::</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DisabledTooltips.js" className="my-16" iframe={false} component={DisabledTooltipsComponent} raw={DisabledTooltipsRaw}/></Typography>
    <Typography className="text-14 mb-32" component="div">:::warning
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TransitionsTooltips.js" className="my-16" iframe={false} component={TransitionsTooltipsComponent} raw={TransitionsTooltipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FollowCursorTooltips.js" className="my-16" iframe={false} component={FollowCursorTooltipsComponent} raw={FollowCursorTooltipsRaw}/></Typography>
...
You need to create an object shaped like the <a href="https://popper.js.org/docs/v2/virtual-elements/"><code>{`VirtualElement`}</code></a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AnchorElTooltips.js" className="my-16" iframe={false} component={AnchorElTooltipsComponent} raw={AnchorElTooltipsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DelayTooltips.js" className="my-16" iframe={false} component={DelayTooltipsComponent} raw={DelayTooltipsRaw}/></Typography>
...
Note that you shouldn&#39;t use <code>{`describeChild`}</code> if the tooltip provides the only visual label. Otherwise, the child would have no accessible name and the tooltip would violate <a href="https://www.w3.org/WAI/WCAG21/Understanding/label-in-name.html">success criterion 2.5.3 in WCAG 2.1</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AccessibilityTooltips.js" className="my-16" iframe={false} component={AccessibilityTooltipsComponent} raw={AccessibilityTooltipsRaw}/></Typography>
