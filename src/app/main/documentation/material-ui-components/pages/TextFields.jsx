...
It comes with three variants: outlined (default), filled, and standard.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BasicTextFields.js" className="my-16" iframe={false} component={BasicTextFieldsComponent} raw={BasicTextFieldsRaw}/></Typography>
...
but Material UI will continue to support it.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FormPropsTextFields.js" className="my-16" iframe={false} component={FormPropsTextFieldsComponent} raw={FormPropsTextFieldsRaw}/></Typography>
...
The <code>{`helperText`}</code> prop can then be used to provide feedback to the user about the error.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ValidationTextFields.js" className="my-16" iframe={false} component={ValidationTextFieldsComponent} raw={ValidationTextFieldsRaw}/></Typography>
...
You can use the <code>{`minRows`}</code> and <code>{`maxRows`}</code> props to bound it.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="MultilineTextFields.js" className="my-16" iframe={false} component={MultilineTextFieldsComponent} raw={MultilineTextFieldsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SelectTextFields.js" className="my-16" iframe={false} component={SelectTextFieldsComponent} raw={SelectTextFieldsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="InputWithIcon.js" className="my-16" iframe={false} component={InputWithIconComponent} raw={InputWithIconRaw}/></Typography>
...
For instance, you can use an icon button to hide or reveal the password.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="InputAdornments.js" className="my-16" iframe={false} component={InputAdornmentsComponent} raw={InputAdornmentsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TextFieldSizes.js" className="my-16" iframe={false} component={TextFieldSizesComponent} raw={TextFieldSizesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="TextFieldHiddenLabel.js" className="my-16" iframe={false} component={TextFieldHiddenLabelComponent} raw={TextFieldHiddenLabelRaw}/></Typography>
...
Using <code>{`none`}</code> (default) doesn&#39;t apply margins to the <code>{`FormControl`}</code> whereas <code>{`dense`}</code> and <code>{`normal`}</code> do.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="LayoutTextFields.js" className="my-16" iframe={false} component={LayoutTextFieldsComponent} raw={LayoutTextFieldsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FullWidthTextField.js" className="my-16" iframe={false} component={FullWidthTextFieldComponent} raw={FullWidthTextFieldRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="StateTextFields.js" className="my-16" iframe={false} component={StateTextFieldsComponent} raw={StateTextFieldsRaw}/></Typography>
...
Then, it&#39;s up to the user to use the underlying component shown in the following demo. Still, you can use <code>{`inputProps`}</code> (and <code>{`InputProps`}</code>, <code>{`InputLabelProps`}</code> properties) if you want to avoid some boilerplate.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ComposedTextField.js" className="my-16" iframe={false} component={ComposedTextFieldComponent} raw={ComposedTextFieldRaw}/></Typography>
    <Typography className="text-24 mt-24 mb-10 font-700" component="h2">Inputs</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="Inputs.js" className="my-16" iframe={false} component={InputsComponent} raw={InputsRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorTextFields.js" className="my-16" iframe={false} component={ColorTextFieldsComponent} raw={ColorTextFieldsRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedInputsStyled.js" className="my-16" iframe={false} component={CustomizedInputsStyledComponent} raw={CustomizedInputsStyledRaw}/></Typography>
...
See the <a href="/material-ui/customization/theme-components/#theme-style-overrides">theme style overrides</a> documentation for further details.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedInputsStyleOverrides.js" className="my-16" iframe={false} component={CustomizedInputsStyleOverridesComponent} raw={CustomizedInputsStyleOverridesRaw}/></Typography>
...
Below is an example using the <a href="/material-ui/api/input-base/"><code>{`InputBase`}</code></a> component, inspired by Google Maps.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedInputBase.js" className="my-16" iframe={false} component={CustomizedInputBaseComponent} raw={CustomizedInputBaseRaw}/></Typography>
...
`}
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="UseFormControl.js" className="my-16" iframe={false} component={UseFormControlComponent} raw={UseFormControlRaw}/></Typography>
...
:::</li>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HelperTextMisaligned.js" className="my-16" iframe={false} component={HelperTextMisalignedComponent} raw={HelperTextMisalignedRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="HelperTextAligned.js" className="my-16" iframe={false} component={HelperTextAlignedComponent} raw={HelperTextAlignedRaw}/></Typography>
...
You have to provide a custom implementation of the <code>{`<input>`}</code> element with the <code>{`inputComponent`}</code> property.</Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="FormattedInputs.js" className="my-16" iframe={false} component={FormattedInputsComponent} raw={FormattedInputsRaw}/></Typography>
