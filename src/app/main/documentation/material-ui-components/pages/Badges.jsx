...
function BadgesDoc(props) {
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="SimpleBadge.js" className="my-16" iframe={false} component={SimpleBadgeComponent} raw={SimpleBadgeRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ColorBadge.js" className="my-16" iframe={false} component={ColorBadgeComponent} raw={ColorBadgeRaw}/></Typography>
...
You can learn more about this in the <a href="/material-ui/customization/how-to-customize/">overrides documentation page</a>.</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="CustomizedBadges.js" className="my-16" iframe={false} component={CustomizedBadgesComponent} raw={CustomizedBadgesRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BadgeVisibility.js" className="my-16" iframe={false} component={BadgeVisibilityComponent} raw={BadgeVisibilityRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="ShowZeroBadge.js" className="my-16" iframe={false} component={ShowZeroBadgeComponent} raw={ShowZeroBadgeRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BadgeMax.js" className="my-16" iframe={false} component={BadgeMaxComponent} raw={BadgeMaxRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="DotBadge.js" className="my-16" iframe={false} component={DotBadgeComponent} raw={DotBadgeRaw}/></Typography>
    ...
    <Typography className="text-14 mb-32" component="div"><FuseExample name="BadgeOverlap.js" className="my-16" iframe={false} component={BadgeOverlapComponent} raw={BadgeOverlapRaw}/></Typography>
...
You should provide a full description, for instance, with <code>{`aria-label`}</code>:</Typography>
    <Typography className="text-14 mb-32" component="div"><FuseExample name="AccessibleBadges.js" className="my-16" iframe={false} component={AccessibleBadgesComponent} raw={AccessibleBadgesRaw}/></Typography>
